...
export default function TestimonialsGrid({
  headline = 'What parents and learners say',
  subheadline = 'Trusted by families who want supportive teaching and meaningful academic growth.',
  testimonials = [
    {
      quote: 'My daughter now loves math. The teachers make every lesson practical and fun.',
      name: 'Amelia Carter',
    ...
    {
      quote: 'The mentoring and structure helped me improve my confidence before high school entrance exams.',
      name: 'Noah Patel',
    ...
    {
      quote: 'Excellent communication, caring instructors, and clear progress updates every month.',
      name: 'Sophia Bennett',
